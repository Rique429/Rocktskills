...
class Selenium {
	...
	void createPoint() {
		...
		name.sendKeys("Rick Point");

		WebElement email = driver.findElement(By.cssSelector("input[name=email]"));
		email.sendKeys("jorgehv.silva@outlook.com");

		WebElement cep = driver.findElement(By.cssSelector("input[name=cep]"));
		cep.sendKeys("06260010");
		...
		assertEquals(target,result.getText(), "Verificando a mesnagem de sucesso.");
